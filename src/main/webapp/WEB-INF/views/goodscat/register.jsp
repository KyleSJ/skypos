			...
			<div class="panel panel-success">
				...
				<div class="panel-body">
					...
					<div class="control-label" for="goodsCatName">
						goodsCatName <input id="goodsCatName" class="form-control"
							type="text" name='goodsCatName' placeholder="Enter goodsCatName" />
					</div>

					<div class="control-label" for="goodsCatLoc">
						goodsCatLoc <input id="goodsCatLoc" class="form-control"
							type="text" name='goodsCatLoc' placeholder="Enter goodsCatLoc" />
					</div>

					<div class="control-label" for="posNum">
						<input id="posNum" class="form-control" type="hidden"
							name='posNum' value=<%=request.getParameter("posNum")%>
							placeholder="Enter goodsCatNum" autofocus />
					</div>
					<!-- /.box-body -->
					<br>
