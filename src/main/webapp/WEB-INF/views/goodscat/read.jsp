			...
			<div class="panel-body">
				<form role="form" method="post">
					<div class="form-group" for="goodsCatNum">
						goodsCatNum <input id="goodsCatNum" class="form-control"
							type="text" name='goodsCatNum' value="${goodsCatVO.goodsCatNum}"
							readonly="readonly">
					</div>
				...
				<div class="form-group" for="goodsCatName">
					goodsCatName <input id="goodsCatName" class="form-control"
						type="text" name='goodsCatName' value="${goodsCatVO.goodsCatName}"
						readonly="readonly">
				</div>

				<div class="form-group" for="goodsCatLoc">
					goodsCatLoc <input id="goodsCatLoc" class="form-control"
						type="text" name='goodsCatLoc' value="${goodsCatVO.goodsCatLoc}"
						readonly="readonly">
				</div>
				<!-- /.box-body -->
